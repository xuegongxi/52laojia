...
<script type="text/javascript">
var news_province='${news_province}';
var news_city='${news_city}';
var news_county='${news_county}';
var news_town='${news_town}';
var news_village='${news_village}';
...
<SCRIPT type="text/javascript" src="<%=request.getContextPath() %>/js/modifyMessage.js"></SCRIPT>
<script type="text/javascript">
	...
	function openwin() {
		OpenWindow = window.open("", "newwin",
				"height=800, width=900,toolbar=no ,scrollbars=yes,menubar=no");
		//写成一行
		OpenWindow.document.write("<TITLE>预览</TITLE>");
		OpenWindow.document.write("<BODY BGCOLOR=#ffffff>");
		//OpenWindow.document.write("<h1>Hello!</h1>")
		//OpenWindow.document.write("New window opened!")
		OpenWindow.document.write(UE.getEditor('editor').getContent());
					...
					<div id="ct" class="wp cl">
						<div class="mn">
							<div class="bm cl">
								...
								<div class="bm_c">
									<form id="ttHtmlEditor" method="post"  action="news.do?method=updateNew" >
                                        <input type="hidden" id="news_id" name="news_id" value="${news_id}">
										<table cellspacing="0" cellpadding="0" class="tfm">
											<tr>
												<td>标&nbsp;&nbsp;&nbsp;&nbsp;题：<input type="text" id="news_title" name="news_title"
													value="${news_title}" size="60" /></td>
											</tr>
											<tr>
												<td>信息发布人：<input type="text" id="news_person" name="news_person"
													value="${news_person}" size="40" /></td>
											</tr>
											<tr>
												<td>信息摘要：&nbsp;&nbsp;<textarea id="news_summary" name="news_summary" style="width: 550px;height: 200px">${news_summary}</textarea></td>
											</tr>
											 <tr>
												<td>											
											...
											<tr><td>
											<input type="button" onclick="openwin()" value="预览">
											</td></tr>
										</table>
